        ...
        },
        {
          ...
          slots: {
            fields: [
              ...
              {
                label: '<a href="//phila.gov/ParksandRecreation/getinvolved/friendsgroups/Pages/default.aspx" target="_blank">PPR Friends Group</a>',
                value: function (state) {
                  return state.geocode.data.properties.ppr_friends;
                }
              },
              {
                label: '<a href="//phillywatersheds.org/what_were_doing/community_partnerships" target="_blank">Watershed Group</a>',
                value: function (state) {
                  return state.geocode.data.properties.major_phila_watershed;
                }
              },
              {
                label: '<a href="//phila.gov/commerce/neighborhoods/Pages/RevitalizingCorridors.aspx" target="_blank">Commercial Corridor Cleaning Program</a>',
                value: function (state) {
