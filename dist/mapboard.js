(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('vuex'), require('@cityofphiladelphia/phila-vue-datafetch'), require('@cityofphiladelphia/phila-vue-mapping'), require('@cityofphiladelphia/phila-vue-comps'), require('leaflet'), require('axios')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue', 'vuex', '@cityofphiladelphia/phila-vue-datafetch', '@cityofphiladelphia/phila-vue-mapping', '@cityofphiladelphia/phila-vue-comps', 'leaflet', 'axios'], factory) :
  (factory((global.mapboard = {}),global.Vue,global.Vuex,global.philaVueDatafetch,global.philaVueMapping,global.philaVueComps,global.L,global.axios));
}(this, (function (exports,Vue,Vuex,philaVueDatafetch,philaVueMapping,philaVueComps,L,axios) { 'use strict';
  ...
  var pvmStore = philaVueMapping.pvmStore;
  var pvcStore = philaVueComps.pvcStore;
  ...
  function createStore(config) {
    ...
    var mergeStore = mergeDeep(mb, pvdStore.store);
  ...
  var Popover = philaVueComps.Popover;


  var Mapboard = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.rootClass,style:(_vm.mbRootStyle),attrs:{"id":"mb-root"}},[_c('topic-panel',{class:this.shouldShowTopicPanel}),_vm._v(" "),(this.fullScreenTopicsOnly !== true)?_c('map-panel',{class:this.shouldShowMapPanel},[(this.shouldLoadCyclomediaWidget)?_c('cyclomedia-widget',{directives:[{name:"show",rawName:"v-show",value:(_vm.cyclomediaActive),expression:"cyclomediaActive"}],attrs:{"slot":"cycloWidget","screen-percent":"2"},slot:"cycloWidget"}):_vm._e(),_vm._v(" "),(this.shouldLoadPictometryWidget)?_c('pictometry-widget',{directives:[{name:"show",rawName:"v-show",value:(_vm.pictometryActive),expression:"pictometryActive"}],attrs:{"slot":"pictWidget","apiKey":this.ak,"secretKey":this.sk},slot:"pictWidget"},[(this.pictometryShowAddressMarker)?_c('png-marker',{attrs:{"latlng":[this.geocodeData.geometry.coordinates[1], this.geocodeData.geometry.coordinates[0]],"icon":'images/markers.png',"height":60,"width":40,"offsetX":0,"offsetY":0}}):_vm._e(),_vm._v(" "),(this.pictometryActive)?_c('layer'):_vm._e(),_vm._v(" "),(this.cyclomediaActive && this.pictometryActive)?_c('png-marker',{attrs:{"latlng":_vm.cycloLatlng,"icon":'images/camera2.png',"height":20,"width":30,"offsetX":-2,"offsetY":-2}}):_vm._e(),_vm._v(" "),(this.cyclomediaActive && this.pictometryActive)?_c('view-cone',{attrs:{"latlng":_vm.cycloLatlng,"rotationAngle":_vm.cycloRotationAngle,"hFov":_vm.cycloHFov}}):_vm._e()],1):_vm._e()],1):_vm._e(),_vm._v(" "),(_vm.popover && _vm.popover.length > 0)?_c('popover',{attrs:{"html":_vm.popover}}):_vm._e()],1)},staticRenderFns: [],
    components: {
